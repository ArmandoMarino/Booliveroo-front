    ...
    <div id="about-us">
        ...
        <div class="container">
            ...
            <div class="row justify-content-between">
                <div class="col-12 col-md-5 d-none d-sm-block list-group navbar-aboutus mt-3">
                ...
                <div class="col-12 col-md-7 section rounded-2 mt-3">
                    <section id="story">
        ...
        <div class="container d-flex justify-content-end py-3">
            <div class="me-2">
                <a href="#about-us" class="btn btn-sm btn-primary mt-2 p-2">TORNA SU</a>
            </div>

            <div class="">
                <router-link :to="{ name: 'home' }" class="btn btn-sm btn-secondary mt-2 p-2">TORNA ALLA HOME</router-link>
            </div>
